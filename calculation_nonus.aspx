<%@ Page Title="Calculation | Deloitte GATe" Language="C#" MasterPageFile="~/Delloite.Master" AutoEventWireup="true" CodeBehind="calculation_nonus.aspx.cs" Inherits="DelloiteTR.calculation_nonus" %>
												...
												<div class="tab-content">
													...
													<div class="tab-pane" id="bordered-justified-pill5">
														...
														<div class="form-group form-group-padding">
															...
															<div class="col-sm-8">
																<input clientidmode="Static" runat="server" id="calc_rounded_72"  type="text" class="form-control numberOnly" placeholder="00" value="" />
															</div>
														</div>
														<div class="form-group form-group-padding">
												...
												<div class="tab-content">
													...
													<div class="tab-pane" id="bordered-justified-pill7">
														...
														<div class="form-group form-group-padding">
															<label class="control-label col-sm-4 text-bold">Number of Tax Periods</label>
															<div class="col-sm-8">
																<input clientidmode="Static" runat="server" id="calc_not_72"  type="text" class="form-control numberOnly" placeholder="00" value="" />
															</div>
														</div>
														<div class="form-group form-group-padding">
															<label class="control-label col-sm-4 text-bold">Monthly PPh 25</label>
