<%@ Page Title="Form US | Deloitte GATe" Language="C#" MasterPageFile="~/Delloite.Master" AutoEventWireup="true" CodeBehind="formUs.aspx.cs" Inherits="DelloiteTR.formUs" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Form US</span></h4>
				                                ...
				                                <div class="col-md-6">
					                                ...
					                                <div class="form-group">
                                                        ...
                                                        <div id="div2other" style="display:none;">
						                                    ...
						                                    <textarea maxlength="125" class="form-control" runat="server" id="t1s2f18" rows="3" 
                                                                clientidmode="Static"></textarea>
						                                    <label><i>in Bahasa Indonesia</i></label>
						                                    <textarea maxlength="125" class="form-control" runat="server" id="t1s2f19" rows="3" 
                                                                clientidmode="Static"></textarea>
                                                        </div>
					                                </div>
				                                </div>
									...
									<form class="steps-validation" action="#">
										...
										<fieldset>
											<div class="row">
                                                <div class="panel panel-flat">
												    <div class="panel-heading">
													    <h5 class="panel-title">INFORMATION FROM U.S. 1040</h5>
												    </div>
												    <div class="panel-body">
													    <fieldset>
														    <legend class="text-semibold">1) FTC CALCULATION BASED ON THE EFFECTIVE US TAX RATE</legend>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">a TOTAL INCOME IN U.S. 1040 (LINE 7)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f1" runat="server" clientidmode="Static"  type="text" name="" class="form-control numberOnly2" placeholder="0.00" >
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b1 US TAX DUE (LINE 11)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f2" runat="server" clientidmode="Static"  type="text" name="" class="form-control numberOnly2" placeholder="0.00" >
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b2 SELF-EMPLOYMENT TAX (SCHEDULE 4 LINE 57)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f3" runat="server" clientidmode="Static"  type="text" name="" class="form-control numberOnly2" placeholder="0.00" >
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b3 ADDITIONAL TAX ON IRAS, ETC (SCHEDULE 4 LINE 59)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f4" runat="server" clientidmode="Static"  type="text" name="" class="form-control numberOnly2" placeholder="0.00" >
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b4 NET INVESTMENT INCOME TAX (FORM 8960 - LINE 17)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f5" runat="server" clientidmode="Static"  type="text" name="" class="form-control numberOnly2" placeholder="0.00" >
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b TOTAL US TAX DUE</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f6" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">c EFFECTIVE US TAX RATE</label>
															    <div class="col-sm-8">
																    <div class="input-group money">
																	    <input id="t1s8f7" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
																	    <span class="input-group-addon border-info text-info"><i class="fa fa-percent"></i></span>
																    </div>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">d WAGES - US SOURCED</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f8" runat="server" clientidmode="Static"  type="text" name="" class="form-control numberOnly2" placeholder="0.00">
															    </div>
														    </div>
													    </fieldset>
													    <fieldset>
														    <legend class="text-semibold">2) FTC CALCULATION BASED ON ACTUAL TAX DUE ON US SOURCE INCOME</legend>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">a TOTAL US SOURCE INCOME </label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f9" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b1 US TAX DUE (LINE 11)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f10" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b2 FOREIGN TAX CREDIT (SCHEDULE 3 LINE 48)</label>
                                                                <label style="text-align:right" class="control-label col-sm-2"><b style="font-size: x-large;">(-)</b></label>
															    <div class="col-sm-6 money">
																    <input id="t1s8f11" runat="server" clientidmode="Static"  type="text" name="number" min="0" class="form-control numberOnly2" /> 
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b3 SELF-EMPLOYMENT TAX (SCHEDULE 4 LINE 57)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f12" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b4 ADDITIONAL TAX ON IRAS, ETC (SCHEDULE 4 LINE 59)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f13" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b5 NET INVESTMENT INCOME TAX (FORM 8960 - LINE 17)</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f14" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">b TOTAL ACTUAL US TAXES PAID</label>
															    <div class="col-sm-8 money">
																    <input id="t1s8f15" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">c PERCENTAGE</label>
															    <div class="col-sm-8 money">
																    <div class="input-group money">
																	    <input id="t1s8f16" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
																	    <span class="input-group-addon border-info text-info"><i class="fa fa-percent"></i></span>
																    </div>
															    </div>
														    </div>
													    ...
													    <div class="form-group form-group-padding">
														    <label class="control-label col-sm-4 text-semibold">3) US TAX RATE - USED FOR FTC PURPOSES</label>
														    <div class="col-sm-8 money">
															    <div class="input-group money">
																    <input id="t1s8f17" runat="server" clientidmode="Static"  type="text" name="" class="form-control border-info text-info numberOnly2" readonly>
																    <span class="input-group-addon border-info text-info"><i class="fa fa-percent"></i></span>
															    </div>
														    </div>
													    </div>
												...
												<div style="display:none;" class="panel panel-flat">
													...
													<div class="panel-body">
														<table id="incomeTable1" class="table table-bordered table-striped datatable-responsive">
															<thead>
																<tr>
																	<th rowspan="2">Country of Source</th>
																	<th rowspan="2">Date of receipt</th>
																	<th rowspan="2">Currency</th>
																	<th colspan="2">Amount in Original Currency</th>
																	<th rowspan="2">Appl. Exch. Rate</th>
																	<th colspan="2">Amount in Rupiah</th>
																	<th rowspan="2">Allowed FTC</th>
										...
										<fieldset>
											<div class="row">
												<div class="panel panel-flat">
												    <div class="panel-heading">
													    <h5 class="panel-title">Work Period (For Income Proration Purposes)</h5>
												    </div>
												    <div class="panel-body">
													    <fieldset>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">As In Form 1721A1/A2</label>
															    <div class="col-sm-8">
																    <input id="t1s8f18" runat="server" clientidmode="Static" type="text" name="" class="form-control border-info text-info" readonly>
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">If Diffrent With Form 1721A1/A2, Please Fill In…</label>
															    <div class="col-sm-8">
																    <input onchange="ceks2();return false;" id="t1s8f19" runat="server" clientidmode="Static" type="text" name="" class="form-control" placeholder="Insert Number or 'N/A'" value="N/A" />
															    </div>
														    </div>
														    <div class="form-group form-group-padding">
															    <label class="control-label col-sm-4">Work Period Used</label>
															    <div class="col-sm-8">
																    <input id="t1s8f20" runat="server" clientidmode="Static" type="text" name="" class="form-control border-info text-info" readonly>
															    </div>
														    </div>
													    </fieldset>
												    </div>
										...
										<fieldset>
											<div class="row">
												<div class="panel panel-flat">
													<div class="panel-heading">
														<h5 class="panel-title">Detailed of Income and FTC Information</h5>
														<h6>Dividend, Interest, Rental, Other Income (Exclude Capital Gain/Loss)</h6>
														<p>1. Fill in with the full amount of income as stated in the U.S. 1040. Proportional calculation will be
															done automatically, except for: capital gains and equity compensation.</p>
														<p>2. The foreign tax credit for TAX EXEMPT INTEREST and WAGES is automatically NIL. </p>
														<div class="heading-elements">
															<a type="button" onclick="OverseasDetailed('Detailed of Income and FTC Information', 1)" class="btn btn-primary" data-toggle="modal" data-target="#income-form-1770-s123"><i
																 class="icon-plus3 position-left"></i> Add</a>
														</div>
													</div>
													<div class="panel-body">
														<table id="incomeTableDetailed" class="table table-bordered table-striped datatable-responsive">
															<thead>
																<tr>
																	<th style="text-align: center;" rowspan="2">Items under consideration</th>
																	<th style="text-align: center;" rowspan="2">Line# in the US1040</th>
																	...
																	<th style="text-align: center;" colspan="3">Amount in USD</th>
																	<th style="text-align: center;" colspan="2">Amount in Rupiah</th>
																	<th style="text-align: center;min-width:100px;" rowspan="2">Action</th>
																</tr>
																<tr>
																	<th style="text-align: center;">Full year Income</th>
																	<th style="text-align: center;">Taxable income</th>
																	<th style="text-align: center;">Foreign tax credit</th>
																	<th style="text-align: center;">Taxable Income </th>
																	<th style="text-align: center;">Foreign tax credit</th>
																</tr>
															</thead>
											...
											<div class="row">
												<div class="panel panel-flat">
													<div class="panel-heading">
														...
														<p>2. The foreign tax credit for TAX EXEMPT INTEREST and WAGES is automatically NIL. </p>
														<div class="heading-elements">
															<a type="button" onclick="addcapus();" class="btn btn-primary" data-toggle="modal" data-target="#capital-form-1770"><i class="icon-plus3 position-left"></i>
																Add</a>
														</div>
													</div>
													<div class="panel-body">
										...
										<fieldset>
											<div class="row">
												<div class="panel panel-flat">
													<div class="panel-heading">
														<h5 class="panel-title">IRREGULAR INCOME</h5>
													</div>
													<div class="panel-body">
                                                        ...
                                                        <asp:TextBox style="display:none;" runat="server" type="text" id="irregulartaxcredit" class="form-control numberOnly" placeholder="0.00" ClientIDMode="Static"></asp:TextBox>
													</div>
												</div>
											</div>
										</fieldset>
																...
																<div class="tab-pane has-padding active" id="basic-tab6">
																	...
																	<table id="rentalTable1" class="table table-bordered table-striped datatable-responsive">
																		<thead>
																			<tr>
																				<th>No</th>
																				<th>Country of Source</th>
																				<th>Information</th>
																				<th>Currency</th>
																				<th>Date</th>
																				<th>Amount in Original Currency</th>
																				<th>Appl. Exch. Rate</th>
														...
														<table id="summarytable" class="table table-bordered table-striped datatable-responsive">
															<thead>
																<tr>
																	...
																	<th colspan="3">Amount in Rupiah</th>
																	<th colspan="2">For calculation purposes</th>
																</tr>
																<tr>
																	<th>Gross income</th>
																	<th>Tax paid/withheld</th>
															...
															<tfoot>
                                                                <tr>
																    ...
																    <th class="bg-info-300 text-bold"><b>
									...
									<form class="steps-basic" action="#">
										...
										<fieldset>
											<div class="row">
												<div class="panel panel-flat">
													<div class="panel-heading">
														<h5 class="panel-title">Means of Transportation</h5>
														<div class="heading-elements">
															<a onclick="OverseasAsset(4, 'Means of Transportation')" type="button" class="btn btn-primary" data-toggle="modal" data-target="#asset-form-1770"><i class="icon-plus3 position-left"></i>
																Add</a>
														</div>
													</div>
													<div class="panel-body">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<button type="button" class="close" data-dismiss="modal" onclick="RefreshGeneral()">&times;</button>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal" onclick="RefreshAll()">Cancel</button>
										...
										<div class="col-md-6">
											<fieldset>
												...
												<div class="form-group money">
													...
													<input ID="iefield25" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group money">
                                            ...
                                            <fieldset>
												...
												<div class="form-group money">
													<label>Net income </label>
													<input ID="iefield28" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group money">
													<label>Income tax withheld </label>
													<input ID="iefield29" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
											</fieldset>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<fieldset>
												...
												<div class="form-group money">
													<label>TOTAL NET INCOME</label>
													<input ID="iefieldedit25" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group money">
													<label>ANNUALIZED NET INCOME</label>
                                            ...
                                            <fieldset>
												...
												<div class="form-group money">
													<label>Net income </label>
													<input ID="iefieldedit28" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group money">
													<label>Income tax withheld </label>
													<input ID="iefieldedit29" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
											</fieldset>
										</div>
									</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
						...
						<div class="row">
							<div class="col-md-6">
								<fieldset>
                                    ...
                                    <div class="form-group">
										<label>Description of Income <span class="text-danger">*</span></label>
                                        <div class="">
											<input runat="server" clientidmode="Static" id="od_desc" type="text" class="form-control" placeholder="" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
										<label>Line# in the US1040</label>
                                        <div class="">
											<input runat="server" clientidmode="Static" id="od_line" type="text" class="form-control" placeholder="" />
										</div>
									</div>
									<div class="form-group">
										<label>Currency <span class="text-danger">*</span></label>
										<select onchange="GetExchRateDetailed();" runat="server" clientidmode="Static" id="odi_currency" data-placeholder="Choose an option" class="select">
											<option></option>
										</select>
                                        <input style="display:none;margin-top:5px;" type="text" runat="server" clientidmode="Static" id="odi_currencyother" class="form-control" maxlength="3" />
									</div>
									...
									<div class="form-group">
										...
										<input onchange="GetExchRateDetailed();" type="text" runat="server" clientidmode="Static" id="od_dateofreceipt" class="form-control datepicker" placeholder="dd/mm/yyyy" readonly="readonly" />
									    <div id="od_dateofreceiptgroup">
                                            <select onchange="GetExchRateDetailed();" runat="server" id="od_dateofreceipt2_1" clientidmode="Static"  name="oi_dateofreceipt2_1" data-placeholder="Choose an option" class="select">
									            <option></option>
                                            ...
                                            <select onchange="GetExchRateDetailed();" runat="server" id="od_dateofreceipt2_2_1" name="" data-placeholder="Choose Year" class="select-simple" clientidmode="Static">
									            <option></option>
								            </select>
                                        </div>
                                    </div>
									...
									<div class="form-group">
										...
										<select onchange="GetExchRateDetailed();" runat="server" clientidmode="Static" id="od_interval" data-placeholder="Choose an option" class="select-simple">
											<option></option>
									...
									<div class="form-group money">
										...
										<input type="text" runat="server" clientidmode="Static" id="od_exchrate" class="form-control border-info text-info numberOnly2" readonly="readonly" disabled="disabled" />
									</div>
								</fieldset>
							</div>
							<div class="col-md-6">
								<fieldset>
									...
									<legend class="text-semibold">Amount in USD</legend>
                                    <div class="form-group">
										<label>Full year Income <span class="text-danger">*</span></label>
										<div class="money">
											<input runat="server" clientidmode="Static" id="od_fullyearincome" type="text" class="form-control numberOnly2" placeholder="0.00" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="money">
											<input runat="server" clientidmode="Static" id="od_incomecurrency" type="text" class="form-control border-info text-info" readonly="readonly" disabled="disabled" placeholder="" />
										</div>
									</div>
									<div class="form-group">
										<label>Foreign tax credit</label>
										<div class="money">
											<input type="text" runat="server" clientidmode="Static" id="od_taxpaidcurrency" class="form-control border-info text-info" readonly="readonly" disabled="disabled" placeholder="" />
										</div>
									</div>
									...
									<div class="form-group money">
										<label>Taxable income</label>
										<input type="text" runat="server" clientidmode="Static" id="od_incomerp" class="form-control border-info text-info" readonly="readonly" disabled="disabled" />
									</div>
									<div class="form-group money">
										<label>Foreign tax credit</label>
										<input type="text" runat="server" clientidmode="Static" id="od_taxpaidrp" class="form-control border-info text-info" readonly="readonly" disabled="disabled" />
									</div>
								</fieldset>
							</div>
							<div class="col-md-6">
								<div class="form-group" id="od_irregularincomediv">
									<label class="text-semibold">Irregular Income <span class="text-danger">*</span></label>
									<select runat="server" clientidmode="Static" id="od_irregularincome" data-placeholder="Choose irregular income if any" class="select-simple">
										<option></option>
										<option value="yes">Yes</option>
										<option value="no">No</option>
									</select>
				...
				<div class="modal-footer">
					...
					<button id="btnDetailedAdd" type="submit" class="btn btn-primary" onclick="SaveOverseasDetailed(1); return false;">Save and Add Another <i class="icon-floppy-disk position-right"></i></button>
					<button type="submit" class="btn btn-primary" onclick="SaveOverseasDetailed(0); return false;">Save and Close <i class="icon-floppy-disk position-right"></i></button>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group">
											<label id="as_ownertext">Details (Bank's Name/Others) <span class="text-danger">*</span></label>
	...
	<div id="rental-form-1770" class="modal fade">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header  bg-primary">
					<button type="button" class="close" data-dismiss="modal" onclick="closemodal_overseas(3)">&times;</button>
				...
				<form action="#" class="form-horizontal">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal" onclick="closemodal_overseas(3)">Cancel</button>
								...
								<div class="col-md-6">
									...
									<div class="form-group" style="display:none;">
										...
										<select id="country" data-placeholder="Choose an option" class="select" required>
											...
											<option value="United Arab Erimates">United Arab Emirates</option>
											<option value="United Kingdom">United Kingdom</option>
											<option selected value="United States">United States of America</option>
											<option value="Uraguay">Uruguay</option>
											<option value="Uzbekistan">Uzbekistan</option>
											<option value="Vanuatu">Vanuatu</option>
											<option value="Vatican City State">Vatican City State</option>
									...
									<div class="form-group">
										...
										<select id="data1" data-placeholder="Choose an option" class="select-simple" required>
											<option></option>
											<option value="Various Income">Various Income</option>
    ...
    <script type="text/javascript" src="http://localhost:13627/assets/delloite/assets/js/general-information.js?id=1"></script>
    <script type="text/javascript" src="http://localhost:13627/assets/delloite/assets/js/overseas-income.js?id=1"></script>
    <script type="text/javascript" src="http://localhost:13627/assets/delloite/assets/js/asset-liabilities.js?id=1"></script>
