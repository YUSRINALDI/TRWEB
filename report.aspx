<%@ Page Title="Download Report | Deloitte GATe" Language="C#" MasterPageFile="~/Delloite.Master" AutoEventWireup="true" CodeBehind="report.aspx.cs" Inherits="DelloiteTR.report" %>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="panel panel-body border-top-primary text-center">
                                        ...
                                        <h6 class="no-margin text-semibold">FE-1770</h6>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="panel panel-body border-top-primary text-center">
										...
										<h6 class="no-margin text-semibold">FE-1770-I-hal 1</h6>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="panel panel-body border-top-primary text-center">
										...
										<h6 class="no-margin text-semibold">FE-1770-II</h6>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="panel panel-body border-top-primary text-center">
										...
										<h6 class="no-margin text-semibold">Summary Notkeeping</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										...
										<h6 class="no-margin text-semibold">1770</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox10" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">1770-I-hal 1</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox11" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">1770-I-hal 2</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox12" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">1770-II</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox13" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">1770-III</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox14" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">1770-IV</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox15" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">Lampiran</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox16" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">Ringkasan Catatan</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox17" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">Daftar Pembayaran PP 46-2013</h6>
									</div>
								</div>
								<div class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox18" runat="server"></asp:CheckBox>
										<h6 class="no-margin text-semibold">Daftar Pembayaran OPPT</h6>
									</div>
								</div>
								<div runat="server" id="divinput" class="col-md-3">
									<div class="panel panel-body border-top-danger text-center">
										<asp:CheckBox Visible="false" Checked="true" id="CheckBox19" runat="server"></asp:CheckBox>
