<%@ Page Title="Form Non US | Deloitte GATe" Language="C#" MasterPageFile="~/Delloite.Master" AutoEventWireup="true" CodeBehind="formNonUs.aspx.cs" Inherits="DelloiteTR.formNonUs" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Form Non US</span></h4>
											...
											<div class="row">
												<div class="panel panel-flat">
													<div class="panel-heading">
														...
														<div class="heading-elements">
															<a onclick="ClearWarning();" type="button" class="btn btn-primary" data-toggle="modal" data-target="#capital-form-1770"><i class="icon-plus3 position-left"></i>
																Add</a>
														</div>
													</div>
													<div class="panel-body">
                                                        ...
                                                        <table id="irregulartable" class="table table-bordered table-striped datatable-responsive">
															...
															<tfoot>
                                                                <tr>
																	...
																	<th style='text-align:right;' class="bg-info-300 text-bold"> </th>
															    </tr>
                                                            </tfoot>
														</table>
														...
														<table id="assetTable1" class="table table-bordered table-striped datatable-responsive">
															<thead>
																<tr>
																	...
																	<th style="text-align: center;" rowspan="2">Account Owner</th>
																	<th style="text-align: center;" rowspan="2">Address</th>
																	<th style="text-align: center;" rowspan="2">Country</th>
																	<th style="text-align: center;" rowspan="2">Type of Document</th>
																	<th style="text-align: center;" rowspan="2">Account Number</th>
																	<th style="text-align: center;" rowspan="2">Acquisition Price/Balance</th>
																	<th style="text-align: center;" rowspan="2">Currency</th>
										...
										<div class="col-md-6">
											<fieldset>
												...
												<div class="form-group money">
													...
													<input ID="iefield26" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group money">
													<label>ANNUALIZED INCOME TAX</label>
													<input ID="iefield27" value="0" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group">
													<label class="text-semibold">INCOME TAX WITHHELD </label>
													<div class="money">
														<input ID="iefield21" type="text" class="form-control border-info text-info" readonly="readonly"/>
													</div>
									...
									<div class="row">
										<div class="col-md-6">
                                            ...
                                            <fieldset>
												<legend class="text-semibold">Deductions</legend>
												<div class="form-group">
													<label>Occupational Costs <span class="text-danger">*</span></label>
													<div class="money">
										...
										<div class="col-md-6">
											<fieldset>
												...
												<div class="form-group money">
													<label>ANNUALIZED NET INCOME</label>
													<input ID="iefieldedit26" type="text" class="form-control border-info text-info" readonly="readonly" />
												</div>
												<div class="form-group money">
													<label>ANNUALIZED INCOME TAX</label>
													<input ID="iefieldedit27" type="text" value="0" class="form-control border-info text-info" readonly="readonly" />
												</div>
                                                <div class="form-group">
													<label class="text-semibold">INCOME TAX WITHHELD </label>
													<div class="money">
	...
	<div id="income-form-1770-s123" class="modal fade">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<button type="button" class="close" data-dismiss="modal" onclick="closemodal_overseas(1)">&times;</button>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal" onclick="closemodal_overseas(1)">Cancel</button>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group">
											<label>Account Owner <span class="text-danger">*</span></label>
											<select id="as_owner" data-placeholder="Choose an Option" class="select-simple">
												<option value="-">-</option>
	...
	<div id="capital-form-1770" class="modal fade">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<button type="button" class="close" data-dismiss="modal" onclick="closemodal_overseas(2)">&times;</button>
				...
				<form action="#">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal" onclick="closemodal_overseas(2)">Cancel</button>
